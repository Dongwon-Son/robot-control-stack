...
class Franka(rcs._core.common.Robot):
    ...
    def tam_get_embedding_seq(self) -> int: ...
    def tam_get_history(self, max_rows: int = 50) -> dict: ...
    def tam_get_ideal_model_has_gravity(self) -> bool: ...
    def tam_is_enabled(self) -> bool: ...
    def tam_load_adaptor(self, weight_path: str) -> bool: ...
    def tam_reset(self) -> None: ...
    def tam_set_embedding(self, embedding: numpy.ndarray[tuple[int], numpy.dtype[numpy.float64]]) -> None: ...
    def tam_set_enable_ramp_s(self, seconds: float) -> None: ...
    def tam_set_ideal_model_has_gravity(self, enabled: bool) -> None: ...
    def tam_set_torque_limits(self, limits: numpy.ndarray[tuple[typing.Literal[7]], numpy.dtype[numpy.float64]]) -> None: ...
    def tam_status(self) -> dict: ...
